    ...
    <Container>
      ...
      <Section delay={0.1}>
        ...
        <Paragraph>
          ...
          Solid communicator and resourceful issue solver, proficient at analyzing the industry.
        </Paragraph>
      </Section>

      <Section delay={0.2}>
        <Paragraph>
          Team up with shared corporate administrations dealing with the drives and related business components in different consolidation projects across numerous geologies.
